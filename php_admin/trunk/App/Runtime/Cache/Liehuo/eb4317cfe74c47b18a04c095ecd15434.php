    ...
    <div class="row-fluid">
      <div class="clearfix">
        ...
        <div class="pull-right">
          ...
          <a class="btn btn-white">已领魅力：<?php echo ($data['cnt_glamour']); ?></a>
          <a class="btn btn-white">人均魅力：<?php echo ($data['avg_glamour']); ?></a>
...
<?php if(is_array($data['list'])): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><a href="<?php echo U('UserBase/view?uid='.$v['uid']);?>" target="_blank" class="btn btn-primary">查看资料</a></td>
