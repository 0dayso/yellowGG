        ...
        <div>
            ...
            <form id="login-form" class="m-t" role="form" action="#">
                ...
                <div class="form-group main_input_box hide">
                        ...
                        <img src="/liehuo/index.php/index/verify_code/"  title="看不清？单击此处刷新" onclick="this.src+='?rand='+Math.random();"  style="height:38px;cursor: pointer; vertical-align: middle;float:left" id="verifyImg" />
                </div>
...
<script type="text/javascript">
    $('#login-form').submit(function()
    {
        ...
        $.ajax(
        {
            url : '/liehuo/index.php/index/check_login',
            type : "post",
    ...
    function changecode(){
        ...
        document.getElementById('verifyImg').src='/liehuo/index.php/index/verify_code/'+time;
    }
