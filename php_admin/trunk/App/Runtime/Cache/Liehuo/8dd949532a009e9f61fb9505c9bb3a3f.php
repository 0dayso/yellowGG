      ...
      <div class="clearfix">
        <form action="<?php echo U('save');?>" method="POST" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="desc" value="<?php echo ($data['item']['desc']); ?>" placeholder="选填" maxlength="255" class="form-control">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">缩率图</label>
            <div class="col-sm-6">
              <input type="text" name="thumb" value="<?php echo ($data['item']['thumb']); ?>" placeholder="必填" class="form-control">
            </div>
            <div class="col-sm-4">
              <input type="file" name="file" class="article-image-upload" data-url="<?php echo U('upload');?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">文章内容</label>
            <div class="col-sm-10">
              <textarea name="content" class="form-control an-ckeditor"><?php echo ($data['item']['content']); ?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">发布时间</label>
            <div class="col-sm-10">
              <input type="datetime" name="publish_time" value="<?php echo ($data['item']['publish_time'] ? date('Y-m-d H:i:s',$data['item']['publish_time']) : ''); ?>" placeholder="选填，格式：<?php echo date('Y-m-d H:i:s');?>" class="form-control">
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <button type="submit" class="btn btn-primary">保存</button>
              <a href="<?php echo U('index');?>" class="btn btn-success">返回列表</a>
            </div>
          </div>
        </form>
      </div>
