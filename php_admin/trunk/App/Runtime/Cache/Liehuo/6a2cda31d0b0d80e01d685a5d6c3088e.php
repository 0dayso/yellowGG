...
<?php if($_REQUEST['rdrs_type'] == 'dt'): ?><a href="<?php echo U('update_offline_daily_user');?>" class="btn btn-primary">更新数据</a><?php endif; ?>
          <span class="btn btn-white">记录数：<?php echo ($count); ?></span>
        </div>
      </div>
      <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover text-center">
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><?php echo ($v['n_dau']); ?></td>
                  <td><?php echo ($v['n_reg']); ?></td>
                  <td><?php echo ($v['n_live_host']); ?></td>
                  <td><?php echo ($v['n_live_guest']); ?></td>
                  <td><?php echo ($v['s_pay_sum']); ?></td>
                  <td><?php echo ($v['n_pay_user']); ?></td>
                  <td><?php echo ($v['n_mau']); ?></td>

                  <td><?php echo ($v['n_pay_month_user']); ?></td>
                  <td><?php echo ($v['n_pay_month_secondary_user']); ?></td>
                  <td><?php echo (round($v['n_pay_month_secondary_user']/$v['n_pay_month_user']*100,2)); ?>%</td>

                  <td><?php echo ($v['s_cash_sum']); ?></td>

                  <td><?php echo (round($v['n_reg_pay_user']/$v['n_reg']*100,2)); ?>%</td>
                  <td><?php echo (round($v['s_reg_pay_sum']/$v['n_reg'],2)); ?></td>

                  <td><?php echo (round($v['n_reg_pay_secondary_user']/$v['n_reg']*100,2)); ?>%</td>
                  <td><?php echo (round($v['s_reg_pay_secondary_sum']/$v['n_reg'],2)); ?></td>

                  <td><?php echo ($v['n_android_live_guest']); ?></td>
                  <td><?php echo ($v['s_android_pay_sum']); ?></td>
                  <td><?php echo ($v['n_android_pay_user']); ?></td>
                  <td><?php echo (round($v['n_android_pay_user']/$v['n_android_live_guest']*100,2)); ?>%</td>
                  <td><?php echo (round($v['s_android_pay_sum']/$v['n_android_live_guest'],2)); ?></td>

                  <td><?php echo ($v['n_ios_live_guest']); ?></td>
                  <td><?php echo ($v['s_ios_pay_sum']); ?></td>
                  <td><?php echo ($v['n_ios_pay_user']); ?></td>
                  <td><?php echo (round($v['n_ios_pay_user']/$v['n_ios_live_guest']*100,2)); ?>%</td>
                  <td><?php echo (round($v['s_ios_pay_sum']/$v['n_ios_live_guest'],2)); ?></td>
                  <td><?php echo ($v['s_reg_pay_sum']); ?></td>
                  <td><?php echo ($v['s_reg_pay_secondary_sum']); ?></td>
