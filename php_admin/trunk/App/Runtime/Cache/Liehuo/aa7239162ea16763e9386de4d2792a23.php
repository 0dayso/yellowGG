...
<div id="content">
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="clearfix">
        <form action="<?php echo U('?');?>" method="POST" class="form-horizontal table-responsive">
          <table class="table table-bordered table-striped table-form">
            ...
            <tr>
              ...
              <td>
                <div class="col-md-8">
                  <textarea name="uids" rows="15" placeholder="每行一个UID，或者英文逗号分隔" class="form-control"></textarea>
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td class="text-left">
                <div class="col-md-12">
                  ...
                  <a class="btn btn-white">在用机器人数：<?php echo ($data['count_assign'] ?: '-'); ?></a>
                  <a class="btn btn-white">空闲机器人数：<?php echo ($data['count'] ?: '-'); ?></a>
                  <a class="btn btn-white">总机器人数：<?php echo ($data['cntlib'] ?: '-'); ?></a>
                </div>
              </td>
            </tr>
          </table>
