            ...
            <span class="input-group-addon hide">
              <label class="checkbox"><input type="checkbox" name="time_type" value="finish"<?php echo $_REQUEST['time_type'] == 'finish' ? 'checked' : ''; ?>> 完成时间</label>
                ...
                <div class="pull-right">
                    ...
                    <span class="btn btn-white">人数：<?php echo ($count); ?></span>
                    <span class="btn btn-white">记录数：<?php echo ($pager->totalRows ?: count($list)); ?></span>
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="<?php echo U('fun_subs?id='.$v['id']);?>" target="_blank" class="btn btn-primary">领取记录</a></td>
