...
<?php if(ACTION_NAME == 'daily_user'): ?><div class="form-group">
        ...
        <div class="pull-right">
          <a href="<?php echo U('?download=1',array_merge($_GET ?: [],['page_size' => 'export']));?>" class="btn btn-success hide">导出</a>
...
<?php if(is_array($data['cols'])): $i = 0; $__LIST__ = $data['cols'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$k): $mod = ($i % 2 );++$i;?><td><?php echo ($v[$k]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
...
<script>
window.Data = $.parseJSON('<?php echo json_encode($data);?>') || {};
window.Data.fields =
{
  'recv_user' : '被赞人数',
  'recv_num'  : '被赞次数',
