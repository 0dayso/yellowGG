...
use Cms\Model;
class HeadImageModifyRequestLogModel extends CjAdminLogModel{

	// 根据年月获取车类审核信息
    public function getdateimage($date,$aid=''){
        $imaegs = D($this->name);
