...
class PushMsgController extends PublicController{
    ...
    public function sendIOSUnicast(){
        try {
            ...
            $unicast->setPredefinedKeyValue("device_tokens","97f45ab5524e9fec123c8d26892600de2f86b70edf9b77bd1b25442a1c755fc5");
            $unicast->setPredefinedKeyValue("alert", "IOS单播测试");
            $unicast->setPredefinedKeyValue("payload", );
